            ...
            <section className="relative w-full h-[40vh] md:h-[50vh] overflow-hidden">
                ...
                <div className="relative h-full w-full flex flex-col items-center justify-center text-white px-4">
                    ...
                    <p className="mt-3 text-sm md:text-base opacity-90 max-w-2xl text-center">
                        A reflection on our journey, our values, and the legacy that continues to guide Meezan Group forward.
                    </p>
                </div>
            </section>

            {/* ================= MAIN LAYOUT ================= */}
            <section className="max-w-6xl mx-auto py-16 px-4 md:px-6 lg:px-10 
                ...
                <motion.div className="flex-1 space-y-16">
                    ...
                    {activeTab === "chairman" && (
                        <section className="space-y-8">
                            ...
                            <motion.p variants={fadeChild} className="text-slate-700 leading-relaxed">
                                It is with great pleasure that I, as the Chairman of the Meezan Group of Companies, extend this message of greetings and felicitations. Looking back through the pages of our history, I feel a deep sense of pride in how far we have come since our humble beginnings in 1974. Our journey has been filled with both challenges and triumphs, but the defining factor of our success has always been our unwavering determination. No matter the obstacles or difficulties we faced, my brother Ziaudeen and I stood firm, driven by a “never give up” attitude that continues to guide us to this day.
                                <br /><br />
                                As a child, accompanying my elder siblings to various tea plantations, I was captivated by their scale, beauty, and potential. Even then, I sensed that this industry would one day become my calling and time proved me right. Ziaudeen and I began our journey in planting while still in our late teens. Though the path was marked with setbacks and moments of disappointment, by the grace of Allah, we persevered and remained steadfast through every challenge. </motion.p>
                            ...
                            <motion.p variants={fadeChild} className="text-slate-700 leading-relaxed">
                                One of the most difficult moments in our journey was when our land was taken over by the Land Reform Commission (LRC) in the late 1970’s. It was a loss that deeply affected us. Yet, we knew we had been wronged, and we were determined not to surrender without a fight. What followed was a twelve year legal battle in which both sides did everything possible to assert their claims. Ultimately, we regained the Nagalla Plantation in 1986, the Ancoombra Plantation in 1990, and finally, in 2002, the Hatale Tea Plantation was returned to us as part compensation. In 2009, we further strengthened our operations by acquiring the Dartry Tea Factory. Today, when I reflect on those years of effort, sacrifice, and resilience, I am reminded that it was all worthwhile.

                                <br /><br />
                                With nearly 35 years of experience, a dedicated staff of over 150, and an annual black tea production of almost two million kilograms, we continue to offer our customers what we have always promised superior quality, garden-fresh, handpicked, perfected, and unblended teas. Our pursuit of perfection is matched only by the commitment, perseverance, and integrity that define every aspect of our work. As I often remind my team:
                                <span className="italic"> “If one tries hard enough, the impossible can be made possible.” </span></motion.p>

                            <motion.p variants={fadeChild} className="text-slate-700 leading-relaxed">
                                We sincerely hope that the Sri Lankan tea industry will continue to grow, inspiring tea producers across the nation to strive for the highest standards and strengthen Sri Lanka’s competitive position in the global marketplace.
                            </motion.p>

                            <motion.p variants={fadeChild} className="text-slate-700 leading-relaxed">
                                Our vision is to elevate Meezan Plantations to become one of the best in the region. To achieve this, we have implemented several initiatives to maximize yield. Our plantations in Hatale and Ancoombra currently produce around 2,500 kg per hectare, and our long-term goal is to increase this to 4,000 kg and beyond.
                            </motion.p>
                            <motion.p variants={fadeChild} className="text-slate-700 leading-relaxed">
                                I am pleased to note that we have introduced the CTC (Cut, Twist, Curl) method alongside fully automated orthodox manufacturing at our Ancoombra factory. This makes us one of the few facilities in the region to operate both processes under one roof. Our factories consistently produce some of the finest Mid-Grown Teas, highly sought after both locally and internationally. It comes as no surprise that our unblended teas are frequently preferred by agents and buyers at the Colombo Tea Auction.
                            </motion.p>
                            <motion.p variants={fadeChild} className="text-slate-700 leading-relaxed">
                                Before concluding, I wish to express my heartfelt gratitude on behalf of the entire Meezan Group and on a personal note to my brother Ziaudeen for his relentless support and unwavering dedication, and to all our shareholders for their continued encouragement over the years. Our journey has not been without its challenges, but we have always chosen to move forward with courage and without regret.</motion.p>
                            <motion.p variants={fadeChild} className="text-slate-700 leading-relaxed">
                                We offer our deepest thanks to Allah for His blessings, and to our late father - Meezan Hajiar, whose footsteps we have strived to follow with honour. With many dreams already fulfilled, we look forward to achieving even more in the years to come, InshaAllah. </motion.p>
                    ...
                    {activeTab === "family" && (
                        <section className="space-y-10">
                            ...
                            >
                                <img
                                    src="/assets/img/family/2.jpg"  // change to your main family image
...
We are deeply grateful for our most important strength-our staff. From the factory floors to the tea fields, our dedicated and well-trained team brings heart, pride, and commitment to their work. Their daily contributions, often carried out quietly and with genuine passion, ensure that our teas are crafted with care and that our operations remain consistent and reliable.
                            ...
                            >
                                ...
                                <div className="overflow-hidden rounded-3xl shadow-lg max-w-4xl mx-auto">
                                    <img
                                        src="/assets/img/family/3.jpg"  // update with your image
