...
const Hero =() =>{
    return(
        <>
            {/* Hero banner */}
            <section className="relative  w-full h-[40rem] md:h-[43rem]  overflow-hidden ">
                <div className="text-white text-4xl mt-20   w-full flex  "> 
                    ...
                    <div className="flex flex-row justify-start items-start w-full h-[35rem] md:h-[43rem]">
                        ...
                        <img src="/assets/logo/group-icon.png" alt="hero-logo" className="
                            ...
                            <img src="/assets/img/bung-02.jpg" alt="hero-img" className="object-cover h-[35rem] md:h-[45rem]"/>
                        </div>
                    </div>
                </div>
